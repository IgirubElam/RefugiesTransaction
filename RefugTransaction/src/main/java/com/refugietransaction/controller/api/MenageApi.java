...
public interface MenageApi {
    ...
    @PostMapping(value = APP_ROOT + "/menages/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/menages/{idMenage}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/menages/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/menages/historiqueMouvementStock/{idProduit}/{idMenage}", produces = MediaType.APPLICATION_JSON_VALUE)
